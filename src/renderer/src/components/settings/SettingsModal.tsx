...
import { Key, Gear, Microphone, Terminal, Keyboard, PaintBrush } from '@phosphor-icons/react';
      ...
      {open && (
        <DialogContent size="xl" className="overflow-hidden">
          <DialogHeader>
            ...
            <DialogDescription>Manage how Kedex looks and behaves.</DialogDescription>
          </DialogHeader>
              ...
              <div className="border-b border-line px-5 py-2">
                <TabsList>
                  <TabsTrigger value="appearance">
                    <PaintBrush className="h-3.5 w-3.5" weight="fill" /> Appearance
                  </TabsTrigger>
